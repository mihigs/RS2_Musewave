...
//   const ArtistPage({Key? key, required this.artistId, this.isJamendoArtist = false}) : super(key: key);
...
//   void initState() {
//     super.initState();
//     artistFuture = artistService.getArtistDetails(widget.artistId, widget.isJamendoArtist);
//   }
...
//         child: FutureBuilder<ArtistDetailsDto>(
//           future: artistFuture,
//           builder: (context, snapshot) {
//             if (snapshot.connectionState == ConnectionState.waiting) {
...
//             // Assuming snapshot data is not null after this check
//             var artistDetails = snapshot.data!;
//             return Center(
//               child: Column(
...
//                     ),
//                   ),
//                   child: artistDetails.artist.artistImageUrl != null
//                     ? Image.network(
//                         artistDetails.artist.artistImageUrl!,
//                         fit: BoxFit.cover,
//                       )
//                     : Icon(Icons.person, size: 128, color: Colors.white),
//                 ),
...
//                       itemCount: artistDetails.tracks.length,
//                       itemBuilder: (context, index) {
//                         if (index < artistDetails.tracks.length) {
//                           return CollectionListItem(
//                             StreamingContext(
//                               artistDetails.tracks[index],
//                               widget.artistId,
//                               StreamingContextType.ALBUM,
//                             ),
//                           );
//                         }
//                         return const SizedBox(); // Handle empty or out-of-bounds index
//                       },
//                     ),
//                   ),
//                 ],
